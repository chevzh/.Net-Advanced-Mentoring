...
namespace System.Security.Cryptography
{
    ...
    public class CustomRfc2898DeriveBytes : DeriveBytes
    {
        ...
        public CustomRfc2898DeriveBytes(string password, int saltSize) : this(password, saltSize, 1000) { }
        ...
        public CustomRfc2898DeriveBytes(string password, byte[] salt) : this(password, salt, 1000) { }

        public CustomRfc2898DeriveBytes(string password, byte[] salt, int iterations) : this(password, salt, iterations, HashAlgorithmName.SHA1) { }
        ...
        public CustomRfc2898DeriveBytes(byte[] password, byte[] salt, int iterations) : this(password, salt, iterations, HashAlgorithmName.SHA1) { }
